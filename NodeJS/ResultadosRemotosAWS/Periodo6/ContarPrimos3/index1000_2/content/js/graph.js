...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.252, "minX": 1.5495879E12, "maxY": 1.252, "series": [{"data": [[1.5495879E12, 1.252]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5495879E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.318556701030932, "minX": 1.0, "maxY": 102.0, "series": [{"data": [[8.0, 26.0], [2.0, 2.7777777777777777], [9.0, 72.0], [10.0, 60.0], [11.0, 84.0], [12.0, 85.0], [3.0, 102.0], [13.0, 34.0], [14.0, 21.0], [15.0, 9.5], [16.0, 17.0], [4.0, 64.0], [1.0, 2.318556701030932], [17.0, 53.0], [18.0, 9.0], [19.0, 86.0], [20.0, 87.0], [5.0, 82.0], [21.0, 87.0], [6.0, 84.0], [7.0, 39.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[1.252, 3.4719999999999955]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 21.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.4719999999999955, "minX": 1.5495879E12, "maxY": 3.4719999999999955, "series": [{"data": [[1.5495879E12, 3.4719999999999955]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5495879E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 3.4590000000000014, "minX": 1.5495879E12, "maxY": 3.4590000000000014, "series": [{"data": [[1.5495879E12, 3.4590000000000014]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5495879E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 1.1049999999999982, "minX": 1.5495879E12, "maxY": 1.1049999999999982, "series": [{"data": [[1.5495879E12, 1.1049999999999982]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5495879E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 2.0, "minX": 1.5495879E12, "maxY": 107.0, "series": [{"data": [[1.5495879E12, 107.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.5495879E12, 2.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.5495879E12, 3.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.5495879E12, 81.90000000000009]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.5495879E12, 3.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5495879E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
