...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.0136363636363648, "minX": 1.54960494E12, "maxY": 1.294871794871796, "series": [{"data": [[1.54960494E12, 1.294871794871796], [1.549605E12, 1.0136363636363648]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 5.295950155763241, "minX": 1.0, "maxY": 116.0, "series": [{"data": [[16.0, 17.0], [8.0, 66.0], [2.0, 7.761904761904762], [1.0, 5.295950155763241], [17.0, 77.66666666666667], [10.0, 116.0], [12.0, 88.33333333333333], [13.0, 101.0], [15.0, 94.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[1.2330000000000005, 6.583000000000002]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 17.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 539.0, "minX": 1.54960494E12, "maxY": 6824.65, "series": [{"data": [[1.54960494E12, 6824.65], [1.549605E12, 1925.1]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.54960494E12, 1911.0], [1.549605E12, 539.0]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 5.172727272727275, "minX": 1.54960494E12, "maxY": 6.980769230769224, "series": [{"data": [[1.54960494E12, 6.980769230769224], [1.549605E12, 5.172727272727275]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 5.1590909090909065, "minX": 1.54960494E12, "maxY": 6.97051282051282, "series": [{"data": [[1.54960494E12, 6.97051282051282], [1.549605E12, 5.1590909090909065]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.2772727272727273, "minX": 1.54960494E12, "maxY": 1.311538461538463, "series": [{"data": [[1.54960494E12, 1.311538461538463], [1.549605E12, 0.2772727272727273]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 4.0, "minX": 1.54960494E12, "maxY": 116.0, "series": [{"data": [[1.54960494E12, 116.0], [1.549605E12, 7.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.54960494E12, 4.0], [1.549605E12, 4.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.54960494E12, 7.0], [1.549605E12, 7.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.54960494E12, 106.13999999999965], [1.549605E12, 87.87000000000012]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.54960494E12, 7.0], [1.549605E12, 7.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 5.0, "minX": 3.0, "maxY": 5.0, "series": [{"data": [[3.0, 5.0], [13.0, 5.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 13.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 5.0, "minX": 3.0, "maxY": 5.0, "series": [{"data": [[3.0, 5.0], [13.0, 5.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 13.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 3.6666666666666665, "minX": 1.54960494E12, "maxY": 13.0, "series": [{"data": [[1.54960494E12, 13.0], [1.549605E12, 3.6666666666666665]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 3.6666666666666665, "minX": 1.54960494E12, "maxY": 13.0, "series": [{"data": [[1.54960494E12, 13.0], [1.549605E12, 3.6666666666666665]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 3.6666666666666665, "minX": 1.54960494E12, "maxY": 13.0, "series": [{"data": [[1.54960494E12, 13.0], [1.549605E12, 3.6666666666666665]], "isOverall": false, "label": "Petición HTTP-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
