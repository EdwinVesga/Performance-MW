...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 2.0979999999999968, "minX": 1.549605E12, "maxY": 2.0979999999999968, "series": [{"data": [[1.549605E12, 2.0979999999999968]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 5.0, "minX": 1.0, "maxY": 102.0, "series": [{"data": [[8.0, 30.0], [2.0, 5.09302325581396], [12.0, 102.0], [3.0, 11.107142857142858], [14.0, 93.0], [15.0, 76.0], [16.0, 62.0], [4.0, 17.75], [1.0, 5.0], [17.0, 51.333333333333336], [19.0, 87.5], [20.0, 62.666666666666664], [5.0, 53.0], [21.0, 67.0], [23.0, 95.0], [24.0, 92.0], [6.0, 8.5], [25.0, 86.5], [26.0, 93.5], [7.0, 55.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[2.0979999999999968, 5.9955]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 26.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 5.9955, "minX": 1.549605E12, "maxY": 5.9955, "series": [{"data": [[1.549605E12, 5.9955]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 5.985500000000006, "minX": 1.549605E12, "maxY": 5.985500000000006, "series": [{"data": [[1.549605E12, 5.985500000000006]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.9160000000000003, "minX": 1.549605E12, "maxY": 0.9160000000000003, "series": [{"data": [[1.549605E12, 0.9160000000000003]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.549605E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 4.0, "minX": 1.549605E12, "maxY": 113.0, "series": [{"data": [[1.549605E12, 113.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.549605E12, 4.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.549605E12, 6.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.549605E12, 54.8900000000001]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.549605E12, 7.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.549605E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
