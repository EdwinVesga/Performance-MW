...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.2150000000000005, "minX": 1.54960662E12, "maxY": 1.2150000000000005, "series": [{"data": [[1.54960662E12, 1.2150000000000005]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.54960662E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 3.4129098360655745, "minX": 1.0, "maxY": 93.0, "series": [{"data": [[8.0, 18.0], [2.0, 4.833333333333333], [10.0, 34.0], [12.0, 51.0], [13.0, 49.666666666666664], [15.0, 87.5], [16.0, 78.0], [4.0, 79.0], [1.0, 3.4129098360655745], [18.0, 66.2], [5.0, 45.0], [6.0, 84.0], [7.0, 93.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[1.2150000000000005, 4.497000000000001]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 18.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 4.497000000000001, "minX": 1.54960662E12, "maxY": 4.497000000000001, "series": [{"data": [[1.54960662E12, 4.497000000000001]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54960662E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 4.485000000000003, "minX": 1.54960662E12, "maxY": 4.485000000000003, "series": [{"data": [[1.54960662E12, 4.485000000000003]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54960662E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 1.0340000000000023, "minX": 1.54960662E12, "maxY": 1.0340000000000023, "series": [{"data": [[1.54960662E12, 1.0340000000000023]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54960662E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 3.0, "minX": 1.54960662E12, "maxY": 93.0, "series": [{"data": [[1.54960662E12, 93.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.54960662E12, 3.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.54960662E12, 4.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.54960662E12, 71.94000000000005]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.54960662E12, 4.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.54960662E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
