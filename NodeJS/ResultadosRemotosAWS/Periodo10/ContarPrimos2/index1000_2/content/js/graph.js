...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.00233644859813, "minX": 1.54961664E12, "maxY": 1.7916666666666674, "series": [{"data": [[1.54961664E12, 1.7916666666666674], [1.5496167E12, 1.00233644859813]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5496167E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.1918367346938767, "minX": 1.0, "maxY": 101.0, "series": [{"data": [[4.0, 19.0], [1.0, 2.1918367346938767], [2.0, 2.333333333333333], [9.0, 101.0], [10.0, 98.0], [11.0, 97.66666666666667], [12.0, 46.0], [3.0, 97.0], [13.0, 40.0], [7.0, 65.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[1.116000000000001, 3.1489999999999996]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 13.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 331.2, "minX": 1.54961664E12, "maxY": 5663.866666666667, "series": [{"data": [[1.54961664E12, 952.8], [1.5496167E12, 5663.866666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.54961664E12, 331.2], [1.5496167E12, 1968.8]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5496167E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 2.1261682242990667, "minX": 1.54961664E12, "maxY": 9.229166666666668, "series": [{"data": [[1.54961664E12, 9.229166666666668], [1.5496167E12, 2.1261682242990667]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5496167E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 2.116822429906539, "minX": 1.54961664E12, "maxY": 9.208333333333336, "series": [{"data": [[1.54961664E12, 9.208333333333336], [1.5496167E12, 2.116822429906539]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5496167E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.3446261682242991, "minX": 1.54961664E12, "maxY": 4.493055555555559, "series": [{"data": [[1.54961664E12, 4.493055555555559], [1.5496167E12, 0.3446261682242991]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5496167E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 1.0, "minX": 1.54961664E12, "maxY": 101.0, "series": [{"data": [[1.54961664E12, 101.0], [1.5496167E12, 4.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.54961664E12, 2.0], [1.5496167E12, 1.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.54961664E12, 8.0], [1.5496167E12, 3.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.54961664E12, 101.0], [1.5496167E12, 60.79000000000019]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.54961664E12, 90.75], [1.5496167E12, 3.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5496167E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 2.0, "maxY": 3.0, "series": [{"data": [[2.0, 3.0], [14.0, 2.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 14.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 2.0, "maxY": 3.0, "series": [{"data": [[2.0, 3.0], [14.0, 2.0]], "isOverall": false, "label": "Successes", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 14.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 2.4, "minX": 1.54961664E12, "maxY": 14.266666666666667, "series": [{"data": [[1.54961664E12, 2.4], [1.5496167E12, 14.266666666666667]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5496167E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 2.4, "minX": 1.54961664E12, "maxY": 14.266666666666667, "series": [{"data": [[1.54961664E12, 2.4], [1.5496167E12, 14.266666666666667]], "isOverall": false, "label": "200", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.5496167E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 2.4, "minX": 1.54961664E12, "maxY": 14.266666666666667, "series": [{"data": [[1.54961664E12, 2.4], [1.5496167E12, 14.266666666666667]], "isOverall": false, "label": "Petición HTTP-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.5496167E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
