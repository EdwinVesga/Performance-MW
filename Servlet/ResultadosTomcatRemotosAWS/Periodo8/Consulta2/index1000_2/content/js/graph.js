...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.17, "minX": 1.54960284E12, "maxY": 1.17, "series": [{"data": [[1.54960284E12, 1.17]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.54960284E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.3152507676560905, "minX": 1.0, "maxY": 93.0, "series": [{"data": [[8.0, 93.0], [2.0, 21.57142857142857], [9.0, 92.0], [10.0, 84.0], [11.0, 74.0], [13.0, 55.333333333333336], [14.0, 62.0], [15.0, 45.0], [16.0, 36.0], [1.0, 2.3152507676560905], [17.0, 47.5], [5.0, 72.5], [6.0, 84.0], [7.0, 31.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[1.17, 3.4200000000000004]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 17.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.4200000000000004, "minX": 1.54960284E12, "maxY": 3.4200000000000004, "series": [{"data": [[1.54960284E12, 3.4200000000000004]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54960284E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 3.4089999999999976, "minX": 1.54960284E12, "maxY": 3.4089999999999976, "series": [{"data": [[1.54960284E12, 3.4089999999999976]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54960284E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 1.0159999999999991, "minX": 1.54960284E12, "maxY": 1.0159999999999991, "series": [{"data": [[1.54960284E12, 1.0159999999999991]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54960284E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
