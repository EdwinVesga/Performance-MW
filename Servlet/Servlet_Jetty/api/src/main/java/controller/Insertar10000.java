...
/**
 * Servlet implementation class Insertar10000
 */
@WebServlet("/Insertar10000")
public class Insertar10000 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			estudianteDAO.insertarB(estudiante);
