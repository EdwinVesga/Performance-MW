...
/**
 * Servlet implementation class Insertar100000
 */
@WebServlet("/Insertar100000")
public class Insertar100000 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			estudianteDAO.insertarC(estudiante);
