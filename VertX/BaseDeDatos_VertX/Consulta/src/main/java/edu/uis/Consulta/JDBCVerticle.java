...
public void start(Future<Void> startFuture){
			...
			.put("maxPoolSize", 30).put("username", "root").put("password", "fairy157943").put("database", "universidad").put("charset","UTF-8");
        	...
        	mySQLClient.getConnection( ar -> { 
        	            if (ar.failed()) {
        	            	...
        	            	vertx.eventBus().consumer("eliminar", message -> {
        	            	...
        	            	vertx.eventBus().consumer("insertar", message -> {
