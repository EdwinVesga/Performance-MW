...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.2740000000000005, "minX": 1.54983912E12, "maxY": 1.2740000000000005, "series": [{"data": [[1.54983912E12, 1.2740000000000005]], "isOverall": false, "label": "Grupo de Hilos", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.54983912E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 3.870472008781562, "minX": 1.0, "maxY": 103.0, "series": [{"data": [[8.0, 67.5], [2.0, 8.206349206349204], [10.0, 23.5], [11.0, 83.5], [12.0, 101.0], [3.0, 21.222222222222225], [13.0, 103.0], [15.0, 81.5], [16.0, 102.0], [4.0, 100.0], [1.0, 3.870472008781562], [17.0, 10.0], [18.0, 57.0], [19.0, 101.0], [5.0, 54.0]], "isOverall": false, "label": "Petición HTTP", "isController": false}, {"data": [[1.2740000000000005, 5.430999999999991]], "isOverall": false, "label": "Petición HTTP-Aggregated", "isController": false}], "supportsControllersDiscrimination": true, "maxX": 19.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 4200.0, "minX": 1.54983912E12, "maxY": 4300.0, "series": [{"data": [[1.54983912E12, 4300.0]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.54983912E12, 4200.0]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.54983912E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 5.430999999999991, "minX": 1.54983912E12, "maxY": 5.430999999999991, "series": [{"data": [[1.54983912E12, 5.430999999999991]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54983912E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 5.419000000000011, "minX": 1.54983912E12, "maxY": 5.419000000000011, "series": [{"data": [[1.54983912E12, 5.419000000000011]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54983912E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 1.358000000000001, "minX": 1.54983912E12, "maxY": 1.358000000000001, "series": [{"data": [[1.54983912E12, 1.358000000000001]], "isOverall": false, "label": "Petición HTTP", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.54983912E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 2.0, "minX": 1.54983912E12, "maxY": 133.0, "series": [{"data": [[1.54983912E12, 133.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.54983912E12, 2.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.54983912E12, 5.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.54983912E12, 99.96000000000004]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.54983912E12, 8.0]], "isOverall": false, "label": "95th percentile", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.54983912E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
